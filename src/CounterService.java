...
public class CounterService {
    ...
    private final static String FILE_NAME = "serial";

//Загрузка состояния
     private Integer load() {
        try(ObjectInputStream objIstr = new ObjectInputStream(new FileInputStream(FILE_NAME))) {
...
//  Сохранение состояния
    protected void save(int saveCounter) {
        try (ObjectOutputStream objOStr = new ObjectOutputStream(new FileOutputStream(FILE_NAME))) {
